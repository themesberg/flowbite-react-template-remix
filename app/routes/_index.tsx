          ...
          <div className="grid w-full grid-cols-1 gap-6 md:grid-cols-2">
            {CARDS.map((card) => (
              <a
                ...
                href={card.url}
                target="_blank"
                className="outline-primary-600 dark:outline-primary-500 hover:border-primary-600 dark:hover:border-primary-500 group cursor-pointer overflow-hidden rounded-xl border border-gray-200 bg-gray-50 outline-offset-2 focus:outline-2 dark:border-gray-700 dark:bg-gray-800"
              >
